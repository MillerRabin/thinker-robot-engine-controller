...
bool Pico_VL53L0X::configSensor(VL53L0X_Sense_config_t vl_config) {
  ...
  // print(F("VL53L0X: configSensor "));
  // println((int)vl_config, DEC);
  ...
  case VL53L0X_SENSE_HIGH_SPEED:
    // println("  VL53L0X_SENSE_HIGH_SPEED");
    Status = VL53L0X_SetLimitCheckValue(
        pMyDevice, VL53L0X_CHECKENABLE_SIGNAL_RATE_FINAL_RANGE,
...
/*!
   ...
   print during execution. Defaults to false.
    @returns True if address was set successfully, False otherwise
*/
/**************************************************************************/
...
*/
/**************************************************************************/
VL53L0X_Error Pico_VL53L0X::startMeasurement(bool debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;

  if (Status == VL53L0X_ERROR_NONE) {
    if (debug) {
      printf("sVL53L0X: StartMeasurement\n");
    }
...
*/
/**************************************************************************/
VL53L0X_Error Pico_VL53L0X::stopMeasurement(bool debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
    if (debug) {
      printf("sVL53L0X: StopMeasurement\n");
    }
...
*/
/**************************************************************************/
VL53L0X_Error Pico_VL53L0X::clearInterruptMask(bool debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
    if (debug) {
...
/**************************************************************************/
/*!
    @brief  print a ranging measurement out via print in a human-readable
   format

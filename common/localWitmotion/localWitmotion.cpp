...
volatile uint8_t LocalWitmotion::uartRxBuffer[256];
...
void LocalWitmotion::AutoScanSensor(void) {
	int i, iRetry;
  ...
  memsTxPin(memsTxPin)
{
  ...
  BaseType_t readTaskStatus = xTaskCreate(readDetectorTask, "LocalWitmotion::readDetectorTask", 128, NULL, 5, NULL);

...
UF2_FILE="$SCRIPT_DIR/build/elbow-control/ENGINE_CONTROL_ELBOW.uf2"
...
echo "🦾 Elbow Control Deployment Script"
echo "==============================================="
...
if [ ! -f "$UF2_FILE" ]; then
    ...
    echo "   Build may have failed or not targeted elbow-control."
    exit 1
fi
...
# Copy UF2 file
echo -e "${BLUE}🚀 Copying elbow control firmware...${NC}"
